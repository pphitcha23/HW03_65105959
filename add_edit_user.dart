        ...
        builder: (context) {
          ...
          return TextFormField(
            ...
            decoration: InputDecoration(
              labelText: label,
              labelStyle: TextStyle(color: isFocused ? const Color.fromARGB(255, 77, 77, 77) : Colors.grey),
              prefixIcon: Icon(icon, color: isFocused ? const Color.fromARGB(255, 88, 88, 88) : Colors.grey),
  ...
  Widget buildGenderField() {
    return DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: UnderlineInputBorder(
          borderSide: BorderSide(color: const Color.fromARGB(255, 243, 33, 243)),
        ),
      ),
